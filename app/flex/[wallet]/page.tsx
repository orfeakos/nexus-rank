  ...
  return (
    <main className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl border-2 p-8 text-center"
        ...
        <div className="text-gray-500 text-xs break-all">{wallet}</div>
      </div>
    </main>
  );
}